var BlackjackJS = (function() {
	...
	Card.prototype.getFaceValue = function(currentTotal){
		var value = 0;
	...
	Card.prototype.view = function(){
		...
		return `
			<div class="card ` + this.suit + `">
				...
				<div class="suit">` + cardSuit[this.suit] + `</div>
	...
	Player.prototype.getScore = function(){
		...
		for(var i = 0; i < this.hand.length; i++){
			if(i == 0) points = this.hand[i].getFaceValue(0);
			else points += this.hand[i].getFaceValue(points);
		}
		return points;
	}
